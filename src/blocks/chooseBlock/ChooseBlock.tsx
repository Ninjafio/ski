...
import { TeslaLogo, DocuLogo, MazeLogo, UberLogo, MiroLogo, DiscordLogo, ChooseImg } from "../../img/index"
      ...
      <div className="choose-container-main">
        <div className="choose-wrapper">
          ...
          <div className="choose-text-wrapper">
            ...
            <a href="#" className="choose-link">Read more</a>
          </div>
        </div>
        <ul className="service-list-choose">
          <li className="service-list-item">
            <p className="service-list-item-title">Service Repair</p>
            <p className="service-list-item-descr">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint Velit officia.</p>
          </li>
          <li className="service-list-item">
